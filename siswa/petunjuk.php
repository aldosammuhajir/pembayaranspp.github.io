...
<body>
	<nav>
		...
		<ul>
			...
			<li style="border-bottom: solid;"><a href="petunjuk.php">Petunjuk</a></li>
	...
	<div class="tutorial">
		...
		<h1>PETUNJUK CARA</h1>
		<ol>
			<li><span><i>Login</i> terlebih dahulu</span> sebelum bayar SPP dengan mengisi NISN kalian. Untuk mengaksesnya bisa pilih dipilihan diatas bagian pojok kanan.</li>
