	...
	<div class="container1" align="center">
		<div class="form_spp">
			...
			<form method="post" <?php
										...
										?> action="siswa.php" <?php
																		...
																		?> action="siswa.php" <?php
																			...
																			if ($cek_status['id_petugas'] == '') {
																				...
																				?> action="../action/bayarspp_proses.php?status=nyicil" <?php
																														}
																													} else {
																															?> action="../action/bayarspp_proses.php" <?php
																																				}
																																					?>>
				...
				<input type="submit" value="SETOR FORM" <?php
																		if ($cek_status['status_bayar'] == 'Lunas') {
																			if ($cek_status['id_petugas'] == '') {
																		?> onclick="alert('Anda sebelumnya telah melunaskan SPP. Mohon tunggu Konfirmasi dari kami.')" ; <?php
																																																		} else {
																																																			?> onclick="alert('Anda telah melunaskan SPP. Terima kasih telah Bertransaksi dengan kami.')" ; <?php
																																																																				}
																																																																			} elseif ($cek_status['status_bayar'] == 'Belum Lunas') {
																																																																				if ($cek_status['id_petugas'] == '') {
																																																																					?> onclick="alert('Mohon tunggu Konfirmasi pembayaran sebelumnya dari kami sebelum anda melunaskannya.')" ; <?php
																																																																							} else {
																																																																								?> onclick="return confirm('Apa anda yakin dengan data ini?')" ; <?php
																																																																							}
																																																																						} else {
																																																														?> onclick="return confirm('Apa anda yakin dengan data ini?')" ; <?php
																																																																						}
