			...
			<table border="1">
				...
				?>
					<tr <?php
							...
							?> style="background-color: #FF0097A6;" title="Mohon tunggu sampai siswa ini bertransaksi" <?php
																																					} elseif ($data['id_petugas'] == '') {
																																						?> style="background-color: #FFCB00B6;" title="Konfirmasi dikategori Bayar SPP" <?php
																																																																} else {
																																																																	?> style="background-color: #10FF006D;" title="Siswa ini sudah tuntas membayar SPP" <?php
																																																																																									}
																																																																																										?>>
			...
			<table border="1">
				...
				?>
					<tr <?php
							...
							?> style="background-color: #49FF0091;" <?php
																				} elseif ($data['status_bayar'] == 'Belum Lunas') {
																					?> style="background-color: #FF9D00BD;" <?php
																																		}
